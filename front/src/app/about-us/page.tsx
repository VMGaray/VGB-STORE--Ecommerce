  ...
  return (
    <div className="bg-gray-100 text-gray-700 p-10">
      <div className="max-w-3xl mx-auto text-center space-y-6">
        ...
        <p className="text-lg leading-relaxed">
          Desde nuestros inicios, hemos trabajado con pasión para construir una tienda online donde cada compra se sienta como en casa.
          Nos enorgullece seleccionar productos que mejoran tu vida, brindando atención personalizada y un trato cálido, como si estuvieras comprando en tu tienda de barrio de toda la vida.
        </p>
        <p className="text-lg leading-relaxed">
